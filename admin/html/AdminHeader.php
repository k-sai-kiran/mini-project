  ...
  ?>
    <header>
       <nav class="navbar navbar-expand-lg navbar-light text-light py-3 main-nav" style="background-color: #2d5bb1;">
          <div class="container">
            <a class="navbar-brand" href="index.html">  <a href="AdminHome.php" class="logo"><img src="../images/Profile_images/home.png"style="border-radius:50%; margin-right: 25px;height: 70px;width: 65px;" ></a></a>
